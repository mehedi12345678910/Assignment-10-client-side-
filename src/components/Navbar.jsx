      ...
      <div className="container mx-auto flex justify-between items-center">
        <div className="flex items-center">
          <div className="dropdown md:hidden">
            ...
            <ul
              tabIndex={0}
              className="menu menu-lg dropdown-content mt-3 z-[1] p-3 shadow-2xl bg-base-200 rounded-box w-64"
            >
              <li className="menu-title text-secondary border-b pb-2 mb-2">
                Navigation
              </li>
              {navLinks.map(
                (link) =>
          ...
          <Link
            to="/"
            className="btn btn-ghost normal-case text-xl md:text-2xl font-extrabold text-primary hover:bg-transparent"
          >
          ...
          {user ? (
            <div className="dropdown dropdown-end">
              <div className="flex items-center gap-5">
                <label
                  tabIndex={0}
                  className="btn btn-ghost btn-circle avatar border-2 border-primary hover:border-secondary transition"
                >
                ...
                <div className="hidden md:block items-center">
                  <span className="mr-2 text-base-content/70 text-sm">
                    Theme:
                  </span>
                  <input
                    type="checkbox"
              ...
              <ul
                tabIndex={0}
                className="mt-3 z-[1] p-3 shadow-2xl menu menu-sm dropdown-content bg-base-100 rounded-box w-52"
              >
                ...
                <li className="mt-2">
                  <button
                    onClick={logOut}
                    className="text-error hover:bg-error/80 hover:text-white"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      className="h-5 w-5"
            ...
            <div className="flex gap-2">
              ...
              <Link
                to="/register"
                className="btn btn-secondary btn-sm md:btn-md hidden sm:inline-flex"
              >
                Register
              </Link>
            </div>
