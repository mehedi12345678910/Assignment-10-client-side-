      ...
      <div className="max-w-6xl mx-auto">
        <div className="card lg:card-side bg-base-200 shadow-2xl p-6">
          ...
          <div className="card-body p-4 lg:p-8">
            <h2 className="card-title text-4xl font-extrabold text-primary mb-2">
              {book.title}
            </h2>
            ...
            <h3 className="text-2xl font-bold mt-4 mb-2 text-base-content">
              Summary
            </h3>
        ...
        {user ? (
          <form
            ...
            className="bg-base-300 p-6 rounded-lg shadow-inner space-y-4"
          >
            <textarea
            ...
            <button
              type="submit"
              className={`btn btn-secondary ${isPosting ? "loading" : ""}`}
              disabled={isPosting}
            >
        ...
        <div className="mt-8 space-y-4">
          <h3 className="text-2xl font-bold mb-4">
            User Reviews ({book.comments?.length || 0})
          </h3>
